        ...
        <div className="max-w-md w-full animate-slide-up">
          ...
          <div className="glass-card p-10 mt-12 rounded-3xl">
            ...
            <div className="mt-8 pt-6 border-t border-gray-100 text-center">
              <p className="text-sm text-gray-600 mb-4">Want to create a new admin account?</p>
              <Link to="/asignup" className="text-brand-600 hover:text-brand-800 font-semibold transition-colors">
                Request access →
              </Link>
            </div>
          </div>
