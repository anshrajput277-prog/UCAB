...
const Dlogin = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await axios.post("http://localhost:8000/driver/login", payload);
      setIsLoading(false);
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col font-sans selection:bg-accent selection:text-gray-900">
      ...
      <div className="flex-1 flex items-center justify-center py-20 px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-md w-full animate-slide-up">
          ...
          <div className="glass-card p-10 mt-12 rounded-3xl border-t-4 border-t-emerald-500">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="input-premium pl-11 focus:border-emerald-500 focus:ring-emerald-500"
            ...
            <div className="mt-8 pt-6 border-t border-gray-100 text-center">
              <p className="text-sm text-gray-600 mb-4">Want to drive with Ucab?</p>
              <Link to="/dsignup" className="text-emerald-600 hover:text-emerald-800 font-semibold transition-colors">
                Apply to Drive →
              </Link>
            </div>
          </div>
